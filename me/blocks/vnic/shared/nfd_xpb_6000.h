 ...
 *
 * @file          blocks/vnic/shared/nfd_xpb_6000.h
 * @brief         An API to manage access to NFD configuration data
 */

#ifndef _BLOCKS__SHARED_NFD_XPB_6000_H_
#define _BLOCKS__SHARED_NFD_XPB_6000_H_
...
#endif /* !_BLOCKS__SHARED_NFD_XPB_6000_H_ */
