 ...
 *
 * "event_type" must match the actual type generated by the queue controller on
 * the event bus.  It is not the same as the "EventType" configured in
 * "QueueConfigStatusLow" in general, although they do match for some cases.
