...
#define NS_VNIC_CFG_STATS_RX_FRAMES     (NS_VNIC_CFG_STATS_BASE + 0x18)
#define NS_VNIC_CFG_STATS_RX_MULTICAST  (NS_VNIC_CFG_STATS_BASE + 0x20)
#define NS_VNIC_CFG_STATS_RX_BROADCAST  (NS_VNIC_CFG_STATS_BASE + 0x28)

#define NS_VNIC_CFG_STATS_TX_DISCARDS   (NS_VNIC_CFG_STATS_BASE + 0x30)
#define NS_VNIC_CFG_STATS_TX_ERRORS     (NS_VNIC_CFG_STATS_BASE + 0x38)
#define NS_VNIC_CFG_STATS_TX_OCTETS     (NS_VNIC_CFG_STATS_BASE + 0x40)
#define NS_VNIC_CFG_STATS_TX_FRAMES     (NS_VNIC_CFG_STATS_BASE + 0x48)
#define NS_VNIC_CFG_STATS_TX_MULTICAST  (NS_VNIC_CFG_STATS_BASE + 0x50)
#define NS_VNIC_CFG_STATS_TX_BROADCAST  (NS_VNIC_CFG_STATS_BASE + 0x58)
